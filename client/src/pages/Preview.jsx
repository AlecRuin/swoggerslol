    ...
    try {
        ...
        return(
            <section style={{marginBottom:"2%"}} className="w-70 preview "  id={post_title_hyphen}>
                <div style={{float:`${flipped?"left":"right"}`}} className={`preview-nugget bg-primary black-border`}>
                    <div style={{flexDirection:`${flipped?"row-reverse":"row"}`}} className="flex h-100 w-100 jc-space-between">
                        ...
                        <div className="flex flex-column w-60 m-x-5">
                            ...
                            <div ref={prevTxtRef} className="bold">
                                {/* {data.preview_text} */}
                            </div>
                            <div className="flex jc-space-between" style={{flexDirection:`${(flipped)?"row":"row-reverse"}`}}>
                                <Link to={"/posts/"+post_title_hyphen} className="no-decor button">
                                    <div className="shimmer txt-grad-quaternary">
                                        Learn more
                                    </div>
                                </Link>
                                <a target="_blank" className="no-decor button" href={`https://www.github.com/AlecRuin/${post_title_hyphen}/releases/latest`}>
                                    <div className="shimmer txt-grad-tertiary">Download</div>
                                </a>
                            </div>
                        </div>
                    </div>
